<%@ Page Language="C#" AutoEventWireup="true" CodeFile="globalpresence.aspx.cs" Inherits="globalpresence" %>
...
<%--					<div class="row">
						<div class="col-md-12">
							...
							<iframe src="https://www.google.com/maps/d/embed?mid=1F3z4gUmf0vHc2uRyaLkg7VUcHmgtu4SN" width="640" height="480"></iframe>
						</div>
					</div>--%>
				...
				<div class="overview-grids w3layouts_about_grid_left">
					...
					<div class="container">
						...
						<div class="row" style=" ">
							...
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Maruti1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Suzuki.jpg" alt="" width="100%"></div>

							<div class="col-sm-2" style=" border:groove">	<img src="Img/Nissan.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Renault.jpg" alt="" width="100%"></div>

							<div class="col-sm-2" style=" border:groove">	<img src="Img/Datsun.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Tata.jpg" alt="" width="100%"></div>

							<div class="col-sm-2" style=" border:groove">	<img src="Img/Vw.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Gm.jpg" alt="" width="100%"></div>


							<div class="col-sm-2" style=" border:groove">	<img src="Img/Mahindra-ele1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/SML-isuzu.jpg" alt="" width="100%"></div>

							<div class="col-sm-2" style=" border:groove">	<img src="Img/Swaraj-Mahindra.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Hyundai.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/Kia.jpg" alt="" width="100%"></div>
						...
						<div class="row" style=" ">
							...
							<div class="col-sm-2" style=" border:groove"><img src="Img/nvh1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove;  ">	<img src="Img/Lear1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove;  ">	<img src="Img/E-hwa1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove;  ">	<img src="Img/Hanon1.jpg" width="100%"></div>
						...
						<div class="row" style=" ">
							...
							<div class="col-sm-2" style=" border:groove">	<img src="Img/daikin1.jpg" alt="" width="100%"></div>
							<div class="col-sm-2" style=" border:groove">	<img src="Img/schnieder1.jpg" alt="" width="100%"></div>
